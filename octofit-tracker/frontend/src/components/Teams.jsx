...
const teamsEndpoint = `${apiBaseUrl}/api/teams/` // https://${import.meta.env.VITE_CODESPACE_NAME}-8000.app.github.dev/api/teams/
...
function Teams() {
  ...
  useEffect(() => {
    fetchCollection('teams', teamsEndpoint).then(setTeams).catch((requestError) => setError(requestError.message))
  }, [])
